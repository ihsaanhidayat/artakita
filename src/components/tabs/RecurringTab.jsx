        ...
        {isFormOpen && (
          <>
            ...
            <motion.form
              ...
              onSubmit={handleSave}
              className="fixed bottom-0 left-0 right-0 max-w-lg mx-auto bg-white dark:bg-[#0a0f1c] border-t border-gray-100 dark:border-gray-800 rounded-t-[32px] pb-safe shadow-2xl z-50 max-h-[92dvh] overflow-y-auto no-scrollbar"
            >
