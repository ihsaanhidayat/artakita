...
//           // PERBAIKAN 1: Ganti "items-center" jadi "items-start", tambah "pt-[20vh]" agar modal condong ke atas
//           className="fixed inset-0 z-[100] flex items-start justify-center px-4 pt-[20vh] pb-10 overflow-y-auto bg-black/60 backdrop-blur-md"
//         >
//           <motion.div
//             initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }}
//             transition={{ type: "spring", damping: 25, stiffness: 300 }}
//             // PERBAIKAN 2: Tambahkan "mb-auto" sebagai bantalan ekstra saat di-scroll
//             className="w-full max-w-sm bg-white dark:bg-[#121827] rounded-[32px] p-6 shadow-2xl border border-gray-100 dark:border-gray-800/80 mb-auto"
//           >
